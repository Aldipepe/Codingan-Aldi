...
float calibrationOffset = 0.00; // Nilai offset kalibrasi untuk pH
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Monitoring Gas dan pH dengan berbagai sensor...");
  ...
  pinMode(SensorPin, INPUT); // Inisialisasi pin untuk pH sensor
}
...
void loop() {
  ...
  pHValue = -8.222 * voltage + 34.345; // Formula kalibrasi
